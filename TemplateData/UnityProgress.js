function UnityProgress(gameInstance, progress) {
 ...
 // gameInstance.progress.empty.style.width = (100 * (1 - progress)) + "%";
  ...
  var progressframe = document.createElement("img");
	...
	gameInstance.progressframe.style.top = 284+ 'px';//0+ (gameInstance.offsetHeight * 0.5) + 'px';
	gameInstance.progressframe.style.left = 315 + 'px';//- (gameInstance.offsetWidth * 0.5) + 'px';
	...
	gameInstance.progressbar.style.top = 285+ 'px';
	gameInstance.progressbar.style.left = 317+ 'px';
